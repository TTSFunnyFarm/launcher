...
On the 'Select Components' screen, expand the list for 'Qt 5.13.1' and ensure that the following is ticked...
...
...and click next. Alternatively, you could just install all of Qt 5.13.1, as well as all of the Developer and Designer Tools, but this tutorial aims to save you space so that you can specifically open the Toontown's Funny Farm launcher developer build.
...
Hover over the 'Desktop Qt 5.13.1 MSVC2015 64bit' kit and click 'Manage...'. You will then be greeted with a screen listing your installed 'kits'.

Click 'Desktop Qt 5.13.1 MSVC2017 64bit' in the kits list and and then change the following...
...
Once you have done that, untick the 'Desktop Qt 5.13.1 MSVC2015 64bit' kit and then make sure the new kit listed, 'Desktop Qt 5.13.1 MSVC2017 64bit', is ticked.
